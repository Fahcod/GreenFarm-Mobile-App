...
import EmptyReviews from '../EmptyComponents/EmptyReviews';
...
const StoreReviews = ({data}:{data:any[]}) => {
  return (
    ...
    <Text className='font-poppins-bold text-sm'>Twesigye Fahad</Text>
    <Text className='text-[#454545] font-poppins text-[12px]'>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat quasi enim a, ullam sed iste, autod iusto.</Text>
